...
def compute_geometric_metrics_points(gdth_mesh, gen_mesh):
    ...
    with torch.no_grad():
        ...
        gt_points, gt_normals = sample_points_from_meshes(gdth_mesh, num_samples=3000, return_normals=True)
        ...
        pred_points, pred_normals = sample_points_from_meshes(gen_mesh, num_samples=3000, return_normals=True)
